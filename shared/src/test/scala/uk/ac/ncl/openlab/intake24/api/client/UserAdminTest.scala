...
class UserAdminTest extends ApiTestSuite with RandomData with BeforeAndAfterAll {
  ...
  override def beforeAll(): Unit = {
    val adminRefreshToken = assertSuccessful(signinClient.signin(SurveyAliasCredentials(None, "admin", "uk.ac.ncl.openlab.intake24.api.client.api.client.test"))).refreshToken
